    ...
    public void onApplicationEvent(ApplicationEvent event) {
        ...
        if (userRepository.count() == 0 && providerRepository.count() == 0){
            ...
            Course javaCourseBase = Course.builder()
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/java.png")
                    .created(LocalDateTime.now())
                    .category(itCategory)
                    .credit(credit7_5)
                    .currency(nok)
            ...
            Course sqlCourseBase = Course.builder()
                ...
                """)
                    ...
                    .endDate(LocalDateTime.of(2025, 6, 28, 0, 0))
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/sql.png")
                    .created(LocalDateTime.now())
                    .category(itCategory)
                    .credit(credit2)
                    .currency(nok)
            ...
            Course dotNetCourseBase = Course.builder()
                ...
                """)
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/net.png")
                    .created(LocalDateTime.now())
                    .category(itCategory)
                    .credit(credit4)
                    .currency(nok)
            ...
            Course azureFundamentalsCourseBase = Course.builder()
                ...
                """)
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/azure.webp")
                    .created(LocalDateTime.now())
                    .category(itCategory)
                    .credit(credit2)
                    .currency(nok)
            ...
            Course awsCloudPractitionerCourseBase = Course.builder()
                ...
                """)
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/aws.png")
                    .created(LocalDateTime.now())
                    .category(itCategory)
                    .credit(credit2)
                    .currency(nok)
            ...
            Course seoCourseBase = Course.builder()
                ...
                """)
                    ...
                    .endDate(LocalDateTime.of(2025, 8, 30, 0, 0))
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/seo.png")
                    .created(LocalDateTime.now())
                    .category(dmCategory)
                    .credit(credit2)
                    .currency(nok)
            ...
            Course socialMediaMarketingCourseBase = Course.builder()
                ...
                """)
                    ...
                    .endDate(LocalDateTime.of(2025, 8, 30, 0, 0))
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/smm.png")
                    .created(LocalDateTime.now())
                    .category(dmCategory)
                    .credit(credit2)
                    .currency(nok)
            ...
            Course businessStrategyCourseBase = Course.builder()
                ...
                """)
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/bs.png")
                    .created(LocalDateTime.now())
                    .category(beCategory)
                    .credit(credit10)
                    .currency(nok)
            ...
            Course machineLearningCourseBase = Course.builder()
                ...
                """)
                    ...
                    .endDate(LocalDateTime.of(2025, 8, 30, 0, 0))
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/ml.png")
                    .created(LocalDateTime.now())
            ...
            Course imageRecognitionCourseBase = Course.builder()
                ...
                """)
                    ...
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/ir.png")
                    .created(LocalDateTime.now())
                    .category(dsaCategory)
                    .credit(credit4)
                    .currency(nok)
            ...
            Course databricksCourseBase = Course.builder()
                ...
                """)
                    ...
                    .endDate(LocalDateTime.of(2025, 8, 30, 0, 0))
                    .active(true)
                    .courseImageUrl("https://learniverseconnectblob.blob.core.windows.net/course-images/ai.png")
                    .created(LocalDateTime.now())
                    .category(dsaCategory)
                    .credit(credit2)
                    .currency(nok)
